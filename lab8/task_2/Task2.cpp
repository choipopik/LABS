...
int glas_count(std::string glas, std::string comp_wrd) //функция выводящая кол-во гласных
{
	int counter = 0;
...
std::string is_bukv(std::string s) //не буква - удалить + всё в нижний регистр
{
	std::string result;
...
int main()
{
	...
	std::string glas = "аеёиоуыэюя";
	std::string soglas = "бвгджзйклмнпрстфхчщ";
	int text_size = 0;
	int newword = 0;
